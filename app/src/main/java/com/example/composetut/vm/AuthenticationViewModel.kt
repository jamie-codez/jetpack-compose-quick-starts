package com.example.composetut.vm
...
import com.example.composetut.data.PasswordRequirements
    ...
    private fun authenticate(){
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            withContext(Dispatchers.Main){
                uiState.value = uiState.value.copy(isLoading = false, error = "Something went wrong")
            }
        }
    }
